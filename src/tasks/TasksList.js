...
import { GROUP_BY_TASKS } from '../config/constants'
    ...
    render() {
        ...
        return (
            <div className="mt-3">
                            ...
                            <div className="col-4 col-md-3 col-lg-3 col-sm-6">
                                <div className="form-group">
                                    ...
                                    <select className="form-control" value={this.state.groupBy} onChange={this.updateGroupByVal}>
                                        ...
                                        <option value={GROUP_BY_TASKS.createdOn}>Created On</option>
                                        <option value={GROUP_BY_TASKS.pendingOn}>Pending On</option>
                ...
                <div className="row">
                    <div className="col-12">
                        {/* <TasksTable tasksList={this.state.tasksList} groupBy={this.state.groupBy} searchWord={this.state.searchWord}/> */}

                        <TasksTable {...this.state} />
                    </div>
